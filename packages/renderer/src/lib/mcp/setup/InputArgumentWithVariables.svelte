...
{#if variables.length === 0}
  <InputArgument id={id} onChange={onChange} object={object} />
{:else if object.value}
  <InputArgument id={id} onChange={onChange} object={object} readonly />
{/if}
    ...
    <div class="flex flex-col p-2 gap-2">
      <div class="grid grid-cols-2 gap-4">
        ...
        <div class="flex flex-col">
          ...
          <InputArgument placeholder={value.default} id="variable-{key}-value" onChange={onVariableChange.bind(undefined, key)} object={{...value, description: undefined }} />
        </div>
      </div>
